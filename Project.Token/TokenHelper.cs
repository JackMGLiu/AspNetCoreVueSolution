...
using Project.Token.Cache;
using Project.Token.Model;
        ...
        public static string IssueJWT(TokenModel tokenModel, TimeSpan expiresSliding, TimeSpan expiresAbsoulte)
        {
            ...
            JwtSecurityToken jwt = new JwtSecurityToken(
                ...
                signingCredentials: new Microsoft.IdentityModel.Tokens
                    .SigningCredentials(new SymmetricSecurityKey(Encoding.ASCII.GetBytes("ProjectToken Secret Key")), SecurityAlgorithms.HmacSha256));//使用私钥进行签名加密
